<?php
 require 'connect.php';
$sql = "SELECT * FROM `product` where `id_product` like 'tre%'";
...
<div id="content">
        ...
        <div class="content-section">
                <h2 class="section-heading title"> THE BABY</h2>
                <p class="section-sub-heading">Shop our baby's collections of lightweight outerwear, performance clothing and accessories.</p>
        ...
        <div class="container">
            <div class="category-top row">
                ...
                <p> Sản Phẩm Trẻ Em </p> <span> &#10140; </span>
                <p>Áo Trẻ Em</p><span> </span>
            </div>
        </div>
        <hr class="dongke" width="100%" align="center" /> 
        <div class="container">
...
?>
                            ...
                            <div class="category-right-content-item">
                                ...
                                <a href="index.php?page=cart&id_product=<?php echo $row['id_product'];?>"><i class="shopping ti-shopping-cart"></i></a> 
				...
				?>
                    ...
                    <div class="category-right-bottom row">
                        ...
                        <div class="category-right-bottom-items">
                            ...
                            <div class="category-right-bottom-items">
                            <p><span>&#171</span>1 2 3 4 5 <span>&#187</span> Trang cuối</p>
                        </div>
                        --> 
