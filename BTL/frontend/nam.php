<?php
 require 'connect.php';
$sql = "SELECT * FROM `product` where `id_product` like 'nam%'";
...
<div id="content">
        ...
        <div class="content-section">
                <h2 class="section-heading title"> THE MEN</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="category-left">
                    <ul>
                        <li class="category-left-li "><a href="./nu.php">SẢN PHẨM NỮ <i class="nav-ti-plus ti-plus"></i></a>
                            <ul class="subnav1">
